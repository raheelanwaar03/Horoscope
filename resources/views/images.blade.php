...
<body>
    ...
    @endif
    <div class="container mt-5 mb-5">
    <h2>Please Login or Register your Account to upload your Images</h2>
    <form enctype="multipart/form-data" action="{{ route('login') }}" method="POST">
        <div class="form-group">
            <label for="email">Enter Your Email:</label>
            <input type="email" class="form-control-file" name="email" accept="image/*" required>
        </div>
        <div class="form-group">
            <label for="password">Enter Your Password:</label>
            <input type="email" class="form-control-file" name="password" required>
        </div>
