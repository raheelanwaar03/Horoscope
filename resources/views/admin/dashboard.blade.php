                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                         ...
                         <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                            <div class="card  wallet blue">
                                ...
                                <div class="card-header border-0">
                                    <div class="wallet-info">
                                        <span class="font-w400 d-block text-white">Given Balance</span>
                                        <h4 class="fs-24 font-w600 mb-0 d-inline-flex me-2"></h4>
                                    </div>
                                    <div class="wallet-icon">
                                        <svg width="62" height="39" viewBox="0 0 62 39" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                            <div class="card  wallet">
                                ...
                                <div class="card-header border-0">
                                    <div class="wallet-info">
                                        <span class="font-w400 d-block text-white">Given Amount</span>
                                        <h4 class="fs-24 font-w600 mb-0 d-inline-flex me-2">${{ givenAmount() }}</h4>
                                    </div>
                                    <div class="wallet-icon">
                                        <svg width="62" height="39" viewBox="0 0 62 39" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
