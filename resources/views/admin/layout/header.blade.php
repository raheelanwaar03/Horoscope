            ...
            <div class="dlabnav-scroll">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('Admin.All.Pending.Requests') }}">Pending Deposit</a></li>
                            <li><a href="{{ route('Admin.All.Approved.Requests') }}">Approved Deposit</a></li>
                            <li><a href="{{ route('Admin.All.Rejected.Requests') }}">Rejected Deposit</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                            <div class="menu-icon">
                            ...
                            <span class="nav-text">Widthraw Requests</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{ route('Admin.All.Pending.Widthraw.Requests') }}">Pending Widthraw</a></li>
                            <li><a href="{{ route('Admin.All.Approved.Widthraw.Requests') }}">Approved Widthraw</a>
                            </li>
                            <li><a href="{{ route('Admin.All.Rejected.Widthraw.Requests') }}">Rejected Widthraw</a>
                            </li>
                        </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
